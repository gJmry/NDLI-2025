...
export const POST: RequestHandler = async ({ request }) => {
    try {
        ...
        await transporter.sendMail({
            from: `"${data.name}" <${SMTP_USER}>`, // Ton adresse Gmail
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f4e4c1; border: 3px solid #b89968; border-radius: 10px;">
                    ...
                    <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0;">
                        <p><strong style="color: #4a3621;">🗡️ Nom du guerrier:</strong> ${
                            data.name
                        }</p>
                        <p><strong style="color: #4a3621;">📧 Email du guerrier:</strong> ${
                            data.email
                        }</p>
                        <p><strong style="color: #4a3621;">🎯 Mission:</strong> ${
                            data.subject
                        }</p>
